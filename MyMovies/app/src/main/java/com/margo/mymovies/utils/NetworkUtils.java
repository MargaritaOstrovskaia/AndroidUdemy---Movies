...
public class NetworkUtils {
    ...
    private static final String PAMAMS_MIN_VOTE_COUNT = "vote_count.gte";

    private static final String API_KEY = "c12836549f35b5d92f495714c7a4f5a8";
    private static final String SORT_BY_POPULARITY = "popularity.desc";
    private static final String SORT_BY_TOP_RARED = "vote_average.desc";

    public static final String MIN_VOTE_COUNT_VALUE  = "1000";
    public static final int POPULARITY = 0;
    public static final int TOP_RARED  = 1;
    ...
    public static JSONObject getJSONForReviws(int id, String language){
        URL url = NetworkUtils.buildURLToReviews(id, language);
    ...
    public static JSONObject getJSONForVideos(int id, String language){
        URL url = NetworkUtils.buildURLToVideos(id, language);
    ...
    public static URL buildURL(int sortBy, int page, String language){
        ...
        if(sortBy == POPULARITY)
            ...
            methodOfSort = SORT_BY_TOP_RARED;

        Uri uri = Uri.parse(BASE_URL).buildUpon()
                .appendQueryParameter(PARAMS_API_KEY, API_KEY)
                .appendQueryParameter(PARAMS_LANGUAGE, language)
                .appendQueryParameter(PARAMS_SORT_BY, methodOfSort)
                .appendQueryParameter(PAMAMS_MIN_VOTE_COUNT, MIN_VOTE_COUNT_VALUE)
